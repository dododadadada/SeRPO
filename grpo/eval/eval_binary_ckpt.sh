...
if [ "$STEP" = "final" ]; then
  LORA="grpo/ckpts/vanilla_9b_full_binary_v3i/round1"
  NAME="binary_9b_v3i_step76"; CFG="binary_9b_v3i_step_76"
else
  LORA="grpo/ckpts/vanilla_9b_full_binary_v3i/round1/step_${STEP}"
  NAME="binary_9b_v3i_step${STEP}"; CFG="binary_9b_v3i_step_${STEP}"
fi
