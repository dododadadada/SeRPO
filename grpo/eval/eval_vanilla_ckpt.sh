...
if [ "$STEP" = "final" ]; then
  LORA="grpo/ckpts/vanilla_9b_full_continuous_v3i/round1"
  NAME="vanilla_9b_v3i_step76"; CFG="vanilla_9b_v3i_step_76"
else
  LORA="grpo/ckpts/vanilla_9b_full_continuous_v3i/round1/step_${STEP}"
  NAME="vanilla_9b_v3i_step${STEP}"; CFG="vanilla_9b_v3i_step_${STEP}"
fi
