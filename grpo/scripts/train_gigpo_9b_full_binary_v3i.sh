#!/usr/bin/env bash
# GiGPO Round-1 v3-G on Qwen3.5-9B — cache-fix (v3-F) + per-token KL cap.
...
python -m grpo.trainer.run_grpo --config grpo/trainer/config/gigpo_9b_full_binary_v3i.yaml
