"""
run_rollouts.py — Joint segmentation + per-segment reward scoring for ALL rollouts.

Production version. Reads rollouts from
...
rubric_reward/results/rollout/round0_9b/KS_baseline/seed_<N>.jsonl (one file per
seed), with pretty per-record samples in round0_9b/KS_baseline/pretty/ when
--limit is set.
